...
const VARIANT_CYCLE: AreaVariant[] = ["gradient", "hatched", "dotted"]
    ...
    <div lang={lang === "zh" ? "zh-CN" : "en"} style={{ maxWidth: 1280, margin: "0 auto", padding: "32px 24px", position: "relative", zIndex: 10 }}>
      ...
      <header className="pxw" style={{ marginBottom: 32 }}>
        <div className="pxw-title">
          ...
          <div role="group" aria-label="Language / 语言" style={{ display: "flex", gap: 12, background: "#fff", padding: "4px 8px" }}>
            <button type="button" className="pxtab" style={{ padding: "2px 10px", fontSize: 17, display: "flex", alignItems: "center", gap: 6 }}
              ...
              {lang === "zh" && <span style={{ width: 6, height: 6, borderRadius: "50%", background: lang === "zh" ? "#ffffff" : "#0a0a0a", flexShrink: 0 }} />}中文
            </button>
            <button type="button" className="pxtab" style={{ padding: "2px 10px", fontSize: 17, display: "flex", alignItems: "center", gap: 6 }}
              aria-pressed={lang === "en"} onClick={() => setLang("en")}>
              {lang === "en" && <span style={{ width: 6, height: 6, borderRadius: "50%", background: lang === "en" ? "#ffffff" : "#0a0a0a", flexShrink: 0 }} />}EN
            </button>
          </div>
        </div>
          ...
          <fieldset className="pxfs">
            ...
            <div role="group" aria-label={t.modeGroup} style={{ display: "flex", gap: 16, marginBottom: 20, flexWrap: "wrap", alignItems: "center" }}>
              <button type="button" className="pxtab" style={{ display: "flex", alignItems: "center", gap: 6 }} aria-pressed={mode === "amount"} onClick={() => setMode("amount")}>
                {mode === "amount" && <span style={{ width: 6, height: 6, borderRadius: "50%", background: mode === "amount" ? "#ffffff" : "#0a0a0a", flexShrink: 0 }} />}{t.modeAmount}
              </button>
              <button type="button" className="pxtab" style={{ display: "flex", alignItems: "center", gap: 6 }} aria-pressed={mode === "percent"} onClick={() => setMode("percent")}>
                {mode === "percent" && <span style={{ width: 6, height: 6, borderRadius: "50%", background: mode === "percent" ? "#ffffff" : "#0a0a0a", flexShrink: 0 }} />}{t.modePercent}
              </button>
              {mode === "percent" && (
      ...
      {result && (
        <>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(480px,100%), 1fr))", gap: 24, marginBottom: 32 }}>
            <section className="pxw" aria-label={t.chart1Aria}>
              ...
              <div className="pxw-body chart-scroll">
                ...
                <AreaChart data={areaData} config={chartConfig} stackType="stacked" bloom="low">
                  <Grid />
                  <XAxis dataKey="year" />
            ...
            <section className="pxw" aria-label={t.chart2Aria}>
              ...
              <div className="pxw-body chart-scroll">
                <div style={{ minWidth: 560, height: 320 }}>
                <BarChart data={barData} config={barConfig} bloom="off">
                  <Grid />
                  <XAxis dataKey="year" />
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(280px,100%), 1fr))", gap: 24 }}>
                <div>
                  ...
                  <div style={{ height: 240 }}>
                    <PieChart data={pieStart} config={chartConfig} dataKey="value" nameKey="bucket" innerRadius={0.5} bloom="low">
                      <Legend align="center" />
                      <Tooltip />
                ...
                <div>
                  ...
                  <div style={{ height: 240 }}>
                    <PieChart data={pieEnd} config={chartConfig} dataKey="value" nameKey="bucket" innerRadius={0.5} bloom="low">
                      <Legend align="center" />
                      <Tooltip />
                      <Pie variant="gradient" />
                    </PieChart>
          ...
          <section className="pxw" style={{ marginBottom: 32 }} aria-labelledby="tbl-h">
            ...
            <div className="pxw-body" style={{ padding: 0, overflowX: "auto", maxHeight: 520, overflowY: "auto" }}>
              <table className="pxtable px-num">
